...
bool Scene::Start()
{
	switch (state) {
		...
		case SceneState::PAUSE:
			pauseMenu = Engine::GetInstance().textures.get()->Load("Assets/Textures/UI/Pause_menu_def.png");
			select= Engine::GetInstance().textures.get()->Load("Assets/Textures/UI/Plumas_def.png");
		case SceneState::SETTINGS:
			settingsMenu = Engine::GetInstance().textures.get()->Load("Assets/Textures/UI/Setting_menu_def.png");
		case SceneState::DEATH:
			deathScreen = Engine::GetInstance().textures.get()->Load("Assets/Textures/UI/Game_Over_def.png");
	}
	return true;
}
